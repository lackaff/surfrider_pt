...
<p>NEED A PARAGRAPH ABOUT WHAT IT MEANS TO BE PART OF SURFRIDER </p>
  <img src="img/corecircle.png" class="span2">
		  ...
		  <div class="accordion-heading">
			  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">Core Members</a>
				...
				<div id="collapseOne" class="accordion-body collapse">
					<div class="accordion-inner">
						<div class="row">	
					<img src="img/richard.png" class="span2" id="corepic">
						<ul class="span4">
						...
						<div class="row">	
					<img src="img/Osario.jpg" class="span2" id="corepic">
						<ul class="span4">
						...
						<div class="row">	
					<img src="img/placeholder.jpg" class="span2" id="corepic">
						<ul class="span4">
						...
						<div class="row">	
					<img src="img/hugo.jpg" class="span2" id="corepic">
						<ul class="span4">
					...
					<img src="img/placeholder.jpg" class="span2" id="corepic">
						...
						<div class="row">	
					<img src="img/davide.jpg" class="span2" id="corepic">
						<ul class="span4">
