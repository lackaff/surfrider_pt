	  ...
	  <div class="accordion-group">
		  <div class="accordion-heading">
			  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion5" href="#collapseOne5">
			  	<img   src="<?php echo get_template_directory_uri(); ?>/img/mobileKZAbout.gif" alt="">
				  	<h4 class="KZlabels"> About Us</h4>
			</a>
			</div>
...
<div class="accordion-group">
	...
	<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion5" href="#collapseTwo5">
				<img   src="<?php echo get_template_directory_uri(); ?>/img/mobileKZAction.gif" alt="">
				  	<h4 class="KZlabels">Take Action</h4>
	</a>
	</div>
...
<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion5" href="#collapseThree5">
	<img   src="<?php echo get_template_directory_uri(); ?>/img/mobileKZSurf.gif" alt="">
				  	<h4 class="KZlabels">Surfing</h4>
</a>
</div>
...
<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion5" href="#collapseFour5">
	<img   src="<?php echo get_template_directory_uri(); ?>/img/mobileKZJoin.gif" alt="">
				  	<h4 class="KZlabels">Join Surfrider</h4>
</a>
</div>
